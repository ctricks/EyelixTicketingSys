...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Eyelix | Ticketing System</title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed sidebar-enabled page-loading">
				...
				<div class="aside aside-left d-flex flex-column" id="kt_aside">
					...
					<div class="aside-brand d-flex flex-column align-items-center flex-column-auto pt-5 pt-lg-18 pb-10">
						...
						<div class="btn p-0 symbol symbol-60 symbol-light-primary" href="?page=index" id="kt_quick_user_toggle">
							<div class="symbol-label">
								<img alt="Logo" src="assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" />
							</div>
						</div>
						<!--end::Logo-->
					</div>
					...
					<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10">
						...
						<ul class="nav flex-column">
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="My Accounts">
								<!-- <a href="#" class="nav-link btn btn-icon btn-hover-text-primary btn-lg" data-toggle="tab" data-target="#kt_aside_tab_2" role="tab"> -->
						<a href="#" class="btn btn-icon btn-hover-text-primary btn-lg mb-1" id="kt_quick_actions_toggle" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="My Accounts">
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Create Ticket">
								<a href="{{ route('ticket.index') }}" class=" btn btn-icon btn-hover-text-primary btn-lg">
									<span class="svg-icon svg-icon-xxl">
							...
							<li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="User Management">
								<a href="#" class="nav-link btn btn-icon btn-hover-text-primary btn-lg" data-toggle="tab" data-target="#kt_aside_tab_5" role="tab">
									<span class="svg-icon svg-icon-xxl">
					...
					<div class="footer py-2 py-lg-0 my-5 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Eyelix</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
		...
		<div id="kt_quick_actions" class="offcanvas offcanvas-left p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-10">
				<h3 class="font-weight-bold m-0">My Accounts</h3>
			...
			<div class="offcanvas-content pr-5 mr-n5">
				<div class="row gutter-b">
					<!--begin::Item-->
					<div class="col-6">
						<a href="accountA" class="menu-link btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							...
							<span class="d-block font-weight-bold font-size-h6 mt-2">Account 1</span>
						</a>
					</div>
					<!--end::Item-->
					<!--begin::Item-->
					<div class="col-6">
						<a href="#" class="btn btn-block btn-light btn-hover-primary text-dark-50 text-center py-10 px-5">
							...
							<span class="d-block font-weight-bold font-size-h6 mt-2">Account 2</span>
						</a>
					</div>
					<!--end::Item-->
				</div>
		...
		<div id="kt_quick_panel" class="offcanvas offcanvas-left pt-5 pb-10">
			...
			<div class="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
				<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_logs">Account</a>
					</li>
					<li class="nav-item">
